...
class MLABMImageUploadViewController: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    private func clearUserDefaults() {
        let defaults = UserDefaults.standard
        defaults.setValue(nil, forKey: MLABMTitlesViewController.titleKey)
        defaults.setValue(nil, forKey: MLABMTitlesViewController.subtitleKey)
        defaults.setValue(nil, forKey: MLABMTitlesViewController.priceKey)
        defaults.setValue(nil, forKey: MLABMTitlesViewController.descKey)
        defaults.setValue(nil, forKey: MLABMTitlesViewController.imageKey)
    }
